          ...
          >
            <Accordion.Header>
              <Accordion.Trigger className="flex w-full items-center justify-start gap-x-4">
                <div
                  className={cn(
                    "relative flex items-center space-x-2 rounded-xl p-4 md:p-5 transition-colors",
                ...
                >
                  {item.icon && (
                    <span
                      className={cn(
                        "absolute bottom-6 text-2xl md:text-3xl",
            ...
            <Accordion.Content asChild forceMount>
              ...
              >
                <div className="flex justify-end mr-7 mt-2 md:mr-16">
                  <div
                    className={cn(
                      "relative max-w-md md:max-w-lg rounded-2xl bg-primary px-5 py-3 md:px-6 md:py-4 text-primary-foreground text-base md:text-lg",
                      answerClassName
                    )}
                  >
                    {item.answer}
