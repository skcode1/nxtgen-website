...
export function CardStack<T extends CardStackItem>({
  ...
  const effectiveCardWidth = isMobile ? Math.min(cardWidth, 320) : cardWidth;
  const effectiveCardHeight = isMobile ? Math.min(cardHeight, 220) : cardHeight;
  ...
  return (
    ...
    >
      <div
        ...
        style={{ height: Math.max(isMobile ? 280 : 380, effectiveCardHeight + 80) }}
        tabIndex={0}
        onKeyDown={onKeyDown}
      >
        <div
        ...
        <div
          className="absolute inset-0 flex items-center justify-center sm:items-end"
          style={{
