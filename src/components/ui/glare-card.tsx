...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    "--rainbow":
      "repeating-linear-gradient( 0deg,rgb(147,51,234) calc(var(--step) * 1),rgb(168,85,247) calc(var(--step) * 2),rgb(196,181,253) calc(var(--step) * 3),rgb(216,180,254) calc(var(--step) * 4),rgb(168,85,247) calc(var(--step) * 5),rgb(147,51,234) calc(var(--step) * 6),rgb(124,58,237) calc(var(--step) * 7) ) 0% var(--bg-y)/200% 700% no-repeat",
    "--diagonal":
      "repeating-linear-gradient( 128deg,#1b0b2f 0%,hsl(270,15%,60%) 3.8%,hsl(270,15%,60%) 4.5%,hsl(270,15%,60%) 5.2%,#1b0b2f 10%,#1b0b2f 12% ) var(--bg-x) var(--bg-y)/300% no-repeat",
    "--shade":
